...
- **1.14.4**: Forge 28.2.28, Java 8. GLFW mouse interceptor introduced (`ensureMouseInterceptor()`). Uses `GuiGraphics` for rendering. First version with full GLFW callback replacement.
