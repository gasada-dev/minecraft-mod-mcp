# Minecraft 1.14.4 Fabric Injection Principle

[English](1.14.4+fabric.md)

## Overview

MCP Mod for Minecraft 1.14.4 Fabric uses **SpongePowered Mixin** bytecode injection to hook into the vanilla Minecraft client rendering loop and input handling. The Mixin framework applies compile-time bytecode weaving via the Fabric Loader, redirecting method calls through annotated mixin classes.
...
- **Java 8**: Version 1.14.4 uses `JAVA_8` compatibility
