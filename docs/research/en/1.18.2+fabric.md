# Minecraft 1.18.2 Fabric Injection Principle

[English](1.18.2+fabric.md)

## Overview

MCP Mod for Minecraft 1.18.2 Fabric uses **SpongePowered Mixin** bytecode injection to hook into the vanilla Minecraft client rendering loop and input handling. The Mixin framework applies compile-time bytecode weaving via the Fabric Loader, redirecting method calls through annotated mixin classes.
...
- **Java 17**: Version 1.18.2 uses `JAVA_17` compatibility
