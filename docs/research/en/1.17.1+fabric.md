# Minecraft 1.17.1 Fabric Injection Principle

[English](1.17.1+fabric.md)

## Overview

MCP Mod for Minecraft 1.17.1 Fabric uses **SpongePowered Mixin** bytecode injection to hook into the vanilla Minecraft client rendering loop and input handling. The Mixin framework applies compile-time bytecode weaving via the Fabric Loader, redirecting method calls through annotated mixin classes.
...
- **Java 16**: Version 1.17.1 uses `JAVA_16` compatibility
- Depth-based rendering changes introduced in 1.17
