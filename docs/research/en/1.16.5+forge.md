...
- **1.16.5**: Forge 36.2.34, Java 8. Most stable and widely-used modern Forge version. Full `ensureMouseInterceptor()` support. Widest mod ecosystem compatibility.
